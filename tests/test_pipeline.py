...
async def test_pipeline_no_new_jobs_all_retries_exhausted(mock_app, mock_settings):
    """When all time ranges exhausted with 0 new jobs, no summary is sent (found=0 is silent)."""
    from main import run_pipeline
    ...
    # No summary when nothing was found — keeps the user's notification feed clean
